...
'TODO when removing job remove job product
'TODO when removing product remove job product
Public Class frmMenu
    ...
    Private Sub btn_addToJob_Click(sender As Object, e As EventArgs) Handles btn_addToJob.Click
        If combo_productdesc.Text <> String.Empty And combo_productID.Text <> String.Empty And combo_quantity.Text <> String.Empty And combo_searchByCode.Text <> String.Empty Then
    ...
    Private Sub OpenArrayTestToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles OpenArrayTestToolStripMenuItem.Click
    ...
    Private Sub AddToProductionLogToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AddToProductionLogToolStripMenuItem.Click
        frmProductionLogDebugging.Show()
    End Sub
