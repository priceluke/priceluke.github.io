...
Public Class frmMenu
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        list_currentJob.Items.Add("Current Job")
    ...
    Private Sub combo_productID_SelectedIndexChanged(sender As Object, e As EventArgs) Handles combo_productID.SelectedIndexChanged
    End Sub

    Private Sub combo_productdesc_SelectedIndexChanged(sender As Object, e As EventArgs) Handles combo_productdesc.SelectedIndexChanged
    End Sub
    ...
    Private Sub btn_addToJob_Click(sender As Object, e As EventArgs) Handles btn_addToJob.Click
        ...
        list_currentJob.Items.Add("            " & "eg Component")
        list_currentJob.Items.Add("===========================================================")
    End Sub
End Class
