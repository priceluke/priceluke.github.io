Module structure_definition
    ...
    Public Structure product
        ...
        <VBFixedString(26)> Dim product_desc As String 'Input via Texbox
        <VBFixedString(16)> Dim product_code As String 'Input Via Combo box
    End Structure
    ...
    Public Structure component
        ...
        <VBFixedString(26)> Dim component_desc As String 'Textbox Input
