    ...
    Public Sub populate(ByVal file As String)
        ...
        Select Case file
            ...
            Case "ComponentLocations"
                ...
                For i = 1 To len_ofFile
                    Console.WriteLine(i & "/" & len_ofFile)
                ...
                For o = 0 To (twoD_complocations.Length / 3) - 1
                    If twoD_complocations(o, 0) > 0 And twoD_complocations(o, 1) > 0 Then
            ...
            Case "ProductComponents"
                ...
                For o = 0 To (twoD_ProdComp.Length / 3) - 1
                    If twoD_ProdComp(o, 0) > 0 And twoD_ProdComp(o, 1) > 0 And twoD_ProdComp(o, 2) > 0 Then
