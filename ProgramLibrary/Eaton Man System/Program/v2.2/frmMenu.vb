...
Public Class frmMenu
    ...
    Private Sub JobsToolStripMenuItem_Click(sender As Object, e As EventArgs)
    ...
    Private Sub LocationToolStripMenuItem_Click(sender As Object, e As EventArgs)
        frmRecordEdit_Location.Show()
    End Sub

    Private Sub ComponentToolStripMenuItem_Click(sender As Object, e As EventArgs)
                    ...
                    For d = 0 To listofproducts.Count - 1
                        If product_component_record.product_id = listofproducts(d) Then
                            ...
                            If Record_Present = False Then
                                ...
                                frmPrintLabels.dgvLabels.Rows.Add(product_component_record.component_id, Component_Name_Temp.Trim(), listofproducts_Quantity(d) * product_component_record.quantity, component_returned.component_code.TrimStart.Trim(), "KARDEX")
                            End If
                        End If
                    Next
                Next
    ...
    Private Sub btnRemoveFromJob_Click(sender As Object, e As EventArgs) Handles btnRemoveFromJob.Click
        ...
        End If
    End Sub
    Private Sub JobProductToolStripMenuItem_Click(sender As Object, e As EventArgs)
    ...
    Public Sub update_menu()
        ...
        Else
            For n = 1 To LOF(freefile_job) / Len(job_record)
                ...
                If job_record.job_pinned Then
                    pinned_JobsListBox.Items.Add(String.Format(listboxFormat, job_record.job_name, job_record.job_count))
        ...
        For Each rowView As DataRowView In sorted_job
            ...
            recent_JobsListBox.Items.Add(String.Format(listboxFormat, row("JobName"), row("Count")))
        Next
    ...
    Private Sub recent_JobsListBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles recent_JobsListBox.SelectedIndexChanged
