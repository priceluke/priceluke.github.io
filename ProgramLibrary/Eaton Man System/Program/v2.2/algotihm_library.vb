...
Module algotihm_library
    ...
    Public Function getInsersionIndexProductComponent(ByVal File As String, ByVal searchVal As Integer)
        Dim temp_record_compare As Integer = LOF(1) / Len(product_component_record)
        Dim low As Integer
        low = 0
        Dim high As Integer
        high = frmRecordEditor.lv_ProductComponents.Items.Count()
        Dim i As Integer = 1
        Do While low <= high
            ...
            Catch
                Return 0
            End Try
            If searchVal = product_component_record.product_id Then
                Return i
                Exit Do
            ElseIf searchVal < product_component_record.product_id Then
                high = (i - 1)
            Else
                low = (i + 1)
            End If
        ...
        Select Case file
            ...
            Case "ComponentLocations"
                ...
                For i = 1 To len_ofFile
                    ...
                    If component_location_record.component_id <> 0 Then
                        listview_populate = frmRecordEditor.lv_CompLocation.Items.Add(component_location_record.component_id)
                        listview_populate.SubItems.Add(component_location_record.location_id)
                    End If
                Next
            Case "Locations"
            ...
            Case "ProductComponents"
                ...
                For i = 1 To len_ofFile
                    FileGet(1, product_component_record, i)
                    'insert_point = getInsersionIndexProductComponent("ProductComponent.dat", product_component_record.product_id)
                    listview_populate = frmRecordEditor.lv_ProductComponents.Items.Add(product_component_record.product_id)
                    listview_populate.SubItems.Add(product_component_record.component_id)
                    listview_populate.SubItems.Add(product_component_record.quantity)
                Next
            Case "Jobs"
